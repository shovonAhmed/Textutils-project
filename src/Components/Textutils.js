    ...
    return (
        <div className={`container text-${props.mode==='dark' ? 'light' : 'dark'}`}>
            ...
            <div className='mb-4'>
                ...
                <button disabled={text.length===0} className="btn btn-primary mx-3 mb-3" onClick={handleLower}>Lower case</button>
                <button disabled={text.length===0} className="btn btn-primary mb-3" onClick={handleCopy}>Copy</button>
                <button disabled={text.length===0} className="btn btn-primary mx-3 mb-3" onClick={handleClear}>Clear</button>
            </div>
            <div>
